...
var ConceptsComponent = (function () {
    function ConceptsComponent(_justificationService, _cycConceptService, _router, _routeParams) {
        ...
        this.selectedInputs = this._routeParams.getParam('target');
    }
    ...
    ConceptsComponent.prototype.loadCycQuestions = function () {
        console.log({ 'target': this.allSelectedSentences, 'selectedInputs': this.selectedInputs });
        this._router.navigate(['suggestion', { 'target': this.allSelectedSentences, 'selectedInputs': this.selectedInputs, 'session': this.session }]);
    };
    ConceptsComponent.prototype.fetchConceptsFromCyc = function () {
        this.availableConcepts = this.concepts;
        this.concepts = this._cycConceptService.loadCycConcepts(this.selectedInputs.audience, this.availableConcepts);
    };
...
//# sourceMappingURL=C:/UI_STASH_REPO/LATEST/poc-development/tmp/broccoli_type_script_compiler-input_base_path-tYOsqpIh.tmp/0/app/+concepts/concepts.component.js.map