...
var DomainService = (function () {
    function DomainService(_http) {
        ...
        this._http.get(endpoints_1.endpoints.GET_DOMAIN_DATA + "?name=Strategic Audience")
            ...
            .subscribe(function (data) { return _this.STRATEGIC_AUDIENCE = data.names; });
        this._http.get(endpoints_1.endpoints.GET_DOMAIN_DATA + "?name=Business Objective")
            .map(function (res) { return res.json(); })
            .subscribe(function (data) { return _this.BUSINESS_OBJECTIVES = data.names; });
        this._http.get(endpoints_1.endpoints.GET_DOMAIN_DATA + "?name=KPI")
            .map(function (res) { return res.json(); })
            .subscribe(function (data) { return _this.KPIS = data.names; });
        this._http.get(endpoints_1.endpoints.GET_DOMAIN_DATA + "?name=Product Name")
            .map(function (res) { return res.json(); })
            .subscribe(function (data) { return _this.PRODUCTS = data.names; });
        this._http.get(endpoints_1.endpoints.GET_DOMAIN_DATA + "?name=Client Name")
            .map(function (res) { return res.json(); })
            .subscribe(function (data) { return _this.CLIENTS = data.names; });
    }
...
//# sourceMappingURL=C:/UI_STASH_REPO/LATEST/poc-development/tmp/broccoli_type_script_compiler-input_base_path-tYOsqpIh.tmp/0/app/shared/domain.service.js.map